...
from .views import PatientList, PatientDetail, PatientSearchView, GoalsAssessmentView, GoalsAssessmentDetailView, FileUploadView, FileDownloadView, FileDeleteView
